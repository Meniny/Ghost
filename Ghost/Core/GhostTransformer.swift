...
class GhostTransformer {
    ...
    static func object<T>(object: Any?) throws -> T {
        ...
        throw GhostError.parse(code: underlying?._code, message: "The data couldn’t be transformed into \(T.self).", object: object, underlying: underlying)
    }
    ...
    static func decode<D: Decodable>(object: Any?) throws -> D {
        ...
        throw GhostError.parse(code: underlying?._code, message: "The data couldn’t be transformed into \(D.self).", object: object, underlying: underlying)
    }
