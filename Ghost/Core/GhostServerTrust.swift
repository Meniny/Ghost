...
/// The `GhostServerTrust` evaluates the server trust generally provided by an `NSURLAuthenticationChallenge` when
    ...
    public func evaluate(_ serverTrust: SecTrust, host: String) -> Bool {
        ...
        case let .pinPublicKeys(pinnedPublicKeys, validateCertificateChain, validateHost):
            ...
            if certificateChainEvaluationPassed {
                outerLoop: for serverPublicKey in GhostServerTrust.publicKeys(serverTrust) as [AnyObject] {
